...
image:https://github.com/yuaming/swift-photoframe/blob/yuaming/image/navigation-interface.png[45%, 45%]
image:https://github.com/yuaming/swift-photoframe/blob/yuaming/image/navigation-stack.png[45%, 45%]
