...
image:https://github.com/yuaming/practice-swift/raw/master/image/navigation-interface.png[45%, 45%]
image:https://github.com/yuaming/practice-swift/raw/master/image/navigation-stack.png[45%, 45%]
