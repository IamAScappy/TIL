...
image:./image/view-view-controller-responder.png[45%, 45%]
image:./image/view-view-controller-responder-chain.png[45%, 45%]
...
image:./image/view-view-controller-delegate.png[45%, 45%]
image:./image/view-view-controller-target-action.png[45%, 45%]
